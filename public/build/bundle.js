...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 8, 0, 198);
    		},
    ...
    /* src\components\Tela.svelte generated by Svelte v3.52.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(/*valor*/ ctx[0]);
    			add_location(span, file$2, 5, 4, 164);
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(`tela ${/*tamanhoFonte*/ ctx[1]}`) + " svelte-9bqj87"));
    			add_location(div, file$2, 4, 0, 122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*tamanhoFonte*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(`tela ${/*tamanhoFonte*/ ctx[1]}`) + " svelte-9bqj87"))) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (valor === undefined && !('valor' in $$props || $$self.$$.bound[$$self.$$.props['valor']])) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 17, 0, 388);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			const tela_changes = {};
    			if (dirty & /*obj*/ 1) tela_changes.valor = /*obj*/ ctx[0].valor;
